...
[2026-07-21 tracked-only spec](2026-07-21-T2-overlay异步结果一致性-spec.md)保留为历史决策记录。
其“raw detection 不覆盖 tracked snapshot”意图继续有效，但旧单槽 store 接口已由本文的
source-scoped `ssv_meta` 与因果 history 替代。
