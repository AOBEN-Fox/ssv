...
missing_deps=()
for dep in gstreamer-1.0 gstreamer-base-1.0 gstreamer-video-1.0 yaml-cpp hiredis nlohmann_json libjpeg blas lapack; do
...
if [ "${#missing_deps[@]}" -gt 0 ]; then
    ...
    ssv_warn "Install GStreamer, yaml-cpp, hiredis, nlohmann-json, libjpeg, BLAS, and LAPACK development packages with your system package manager."
